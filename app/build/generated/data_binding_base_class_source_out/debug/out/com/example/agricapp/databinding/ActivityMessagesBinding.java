...
public final class ActivityMessagesBinding implements ViewBinding {
  ...
  private ActivityMessagesBinding(@NonNull CoordinatorLayout rootView,
      @NonNull BottomNavigationView bottomNavigation, @NonNull LinearLayout messagesContainer) {
  ...
  public static ActivityMessagesBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityMessagesBinding((CoordinatorLayout) rootView, bottomNavigation,
          messagesContainer);
    }

...
public final class ItemNotificationBinding implements ViewBinding {
  ...
  private ItemNotificationBinding(@NonNull CardView rootView, @NonNull TextView notificationDesc,
  ...
  public static ItemNotificationBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemNotificationBinding((CardView) rootView, notificationDesc, notificationIcon,

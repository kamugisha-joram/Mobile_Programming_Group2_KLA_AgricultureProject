...
class CropInfoActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // Initialize Data with real images from drawable-nodpi
        allCrops = listOf(
            Crop("Maize", "A cereal crop widely grown in Uganda.", R.drawable.maize_photo, "Cereals"),
            Crop("Rice", "Important cereal grown in swampy areas.", R.drawable.rice_photo, "Cereals"),
            Crop("Beans", "High in protein and well grown in Uganda.", R.drawable.beans_photo, "Legumes"),
            Crop("Soya Beans", "Versatile legume for oil and protein.", R.drawable.soyabeans_photo, "Legumes"),
            Crop("Cassava", "Grows well in warm climates.", R.drawable.cassava, "Root Crops"),
            Crop("Sweet Potatoes", "Staple root crop in many regions.", R.drawable.potatoes, "Root Crops"),
            Crop("Banana", "Source of food and income.", R.drawable.bananas_photo, "Vegetables"),
            Crop("Tomato", "High value vegetable crop.", R.drawable.tomatoes_photo, "Vegetables")
        )
    ...
    private fun displayCrops(crops: List<Crop>) {
        ...
        for (crop in crops) {
            ...
            itemView.setOnClickListener {
                Toast.makeText(this, "Clicked ${crop.name}", Toast.LENGTH_SHORT).show()
            }
